...
void Mixer::showHelp() 
{
   cerr << APPNAME << "PulseMixer.app by Thinksilicon 2022, huge thanks to the authors of the" << endl
        << "original AlsaMixer.app Copyright (c) 1998-2002 by Per Liden (per@fukt.bth.se), Petr Hlavka (xhlavk00@stud.fit.vutbr.cz)" << endl
        << "and Ponymix by Dave Reisner <dreisner@archlinux.org>, Simon Gomizelj <simongmzlj@gmail.com>" << endl
        << "options:" << endl
